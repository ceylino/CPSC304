...
<div style="display: flex;
  ...
  <div style="justify-content: flex-start;">
    <h3> Customers: </h3> <!-- TODO: this table printing set up needs to be completed and added for the other tables as well -->
      <?php
    ...
    <div style="background-color:lightGrey;
      ...
      <center>
        <form action=""> <!-- TODO: Add rerouting to necessary forms -->
          <input type="submit" value="Add new customer" name="newCust">
        </form>
        ...
        <form action=""> <!-- TODO: Add rerouting to necessary forms -->
          <input type="submit" value="Update customer" name="updateCust">
        </form>

        <form action=""> <!-- TODO: Add rerouting to necessary forms -->
          <input type="submit" value="Add membership" name="newMember">
        </form>

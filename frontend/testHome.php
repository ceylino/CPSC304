...
session_start();
// $_SESSION['newC_id'] = 20;
// $_SESSION['newC_name'] = 'lol';
// $_SESSION['newC_email'] = $_POST['newC_email'];
// $_SESSION['newC_CCnum'] = $_POST['newC_CCnum'];
// $_SESSION['newCustomer'] = $_POST['newCustomer'];
// if (isset($_POST['newC_name'])) {
// 	header("location: testCustHome.php");
// }
?>
...
<form method="POST" action="modifiedoracle-test.php">
...
Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Phone Number</font></p>
<form method="POST" action="modifiedoracle-test.php">
<!--refresh page when submit-->

   <p><input type="text" name="insNo" size="6"><input type="text" name="insName" 
size="18"><input type="text" name="insPhone" size="18">
...
<center>
  ...
  <div style="background-color:lightGrey;
              ...
              padding-bottom: 10px">
    <h3>Staff Login</h3>
    <form method="POST" action="testinghome.php">
  ...
  <div style="background-color:lightGrey;
    ...
    <form method="POST" action="testCustHome.php">
...
function printResult($result) { //prints results from a select statement
	...
	while ($row = OCI_Fetch_Array($result, OCI_BOTH)) {
		echo "<tr><td>" . $row["NID"] . "</td><td>" . $row["NAME"] . "</td><td>" . $row["PHONENUMBER"] . "</td></tr>"; //or just use "echo $row[0]" 
	}
	echo "</table>";
...
if ($db_conn) {
	...
	if (array_key_exists('reset', $_POST)) {
		...
		executePlainSQL("create table tab1 (nid number, name varchar2(30), phonenumber varchar2(25), primary key (nid))");
		OCICommit($db_conn);
		...
		if (array_key_exists('insertsubmit', $_POST)) {
			...
			if (array_key_exists('updatesubmit', $_POST)) {
                ...
                if (array_key_exists('updatesubmitnumber', $_POST)) {
                    // Update tuple using data from user
                    $tuple = array (
                        ":bind1" => $_POST['oldNumber'],
                        ":bind2" => $_POST['newNumber']
                    );
                    $alltuples = array (
                        $tuple
                    );
                    executeBoundSQL("update tab1 set phonenumber=:bind2 where phonenumber=:bind1", $alltuples);
                    OCICommit($db_conn);
                } else
